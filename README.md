...
```sh
docker build -t sqlserver-adventureworks-2022 .
```

### 2. Crear el Contenedor Docker

```sh
docker run -d --name sqlserver-adventureworks -p 1400:1433 sqlserver-adventureworks-2022 

# or

docker run -d --name sqlserver-adventureworks -p 1400:1433 -e SA_PASSWORD="NuevaClave123*" sqlserver-adventureworks-2022 
```
